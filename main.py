...
while True:
    ...
    print(str(lightVal[0]) + " Red  " + str(lightVal[1]) + " Green  " + str(lightVal[2]) + " Blue")
...
#     print("{} R  {:5.0f} G  {:5.0f} B  {:5.0f} W  {:5.3f} Lux  {:d} K {} ".format(lightVal[0], lightVal[1], lightVal[2], lightVal[3], lightVal[4], lightVal[5], colour_description))
